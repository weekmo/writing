...
White matter is composed of bundles, which connect various gray matter areas %(the locations of nerve cell bodies)
...
everything is summarized.
	...
	%Brain Tractography is a computational reconstruction method based on diffusion-weighted magnetic resonance imaging (DWI), attempts to reveal the 	trajectories of white matter pathways in vivo and to infer the underlying structural connectome of the human brain\cite{Maier-Hein2017}.\\
	
	%Tractography based on non-invasive diffusion imaging is central to the study of human brain connectivity .
	% nn.4134.pdf, s41467-017-01285-x.pdf
		%\subsection{MRI}
		%Magnetic resonance imaging (MRI) techniques are used to help plan neurosurgery procedures. Scientists construct a 3D map of the patient’s brain, identifying healthy brain regions, and the locations of arteries, veins and important brain nerve fibre tracts and then overlay this map on a live image of the patient’s brain during surgery.\cite{Alliance2018}
		%\hspace{.5cm} 
